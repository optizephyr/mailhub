    ...
    messages: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "content": (
                ...
                "  · **end_at 填写决策表**（按优先级从高到低）：\n"
                "    1. 正文同时出现开始与结束（中间带「-」「~」「至」「结束」之一）"
                "——如「14:00-15:30」「14:00~15:30」「14:00 至 15:30 结束」——填 end_at=结束。\n"
                "    2. 正文说「面试将持续 N 小时 / 持续 N 分钟」——填 task_duration_minutes=N×60，end_at 留空。\n"
                "    3. 正文只说「面试时间：14:00」或「14:00 开始」，没出现结束时间——end_at 留空。\n"
                "    4. 以上都没有时，end_at 留空（由代码按面试 1h / 笔试 2h 算）。\n"
                "  · **end_at 不能填的**：『预约修改截止」、「请于 9/4 前选择」、「可预约期限时间」"
                "等任何跟预约/选择/反馈相关的截止日期——这些是 deadline，不是面试结束。\n"
